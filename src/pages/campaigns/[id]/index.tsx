        ...
        <Stack gap="32px" sx={{ p: 4, maxWidth: 1000, mx: "auto" }}>
          ...
          <Stack direction="row" justifyContent="space-between" alignItems="center">
            ...
            <Stack direction="row" spacing={2}>
              <Button variant='text' sx={{ width: '118px', height: '36px', backgroundColor: '#F1F2F5', borderRadius: '12px', color: 'black', ":hover": { backgroundColor: '#F1F2F5' }, padding: '15px 10px 15px 8px' }}>
          ...
          <Stack gap="8px">
            <Card sx={{ border: '1px solid #E1E2EA', borderRadius: '12px', padding: '16px' }}>
              <Typography color="text.secondary">
                SuperStacks is an experimental pilot campaign designed to show how the
                Superchain can create a more connected onchain experience.
              </Typography>
            </Card>
