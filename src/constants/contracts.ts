...
export const AIRDROP_ABI = [
  ...
  { inputs: [], name: 'AirdropExpired', type: 'error' },
  ...
  { inputs: [], name: 'InvalidConditionId', type: 'error' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'uint256', name: 'tokenConditionId', type: 'uint256' },
  ...
  { inputs: [], name: 'renounceOwnership', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [
      { internalType: 'address', name: '_token', type: 'address' },
      { internalType: 'bytes32', name: '_tokenMerkleRoot', type: 'bytes32' },
